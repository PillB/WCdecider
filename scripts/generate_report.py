...
function renderValidationVisuals(){
 ...
 $('#performance-viz').innerHTML=`<h2 class="text-xl font-black text-white"><span class="en">Prediction performance and model comparison</span><span class="es">Rendimiento predictivo y comparación de modelos</span></h2>
  ...
  <div class="research-performance hidden mt-4">
   ...
   <p class="mt-3 rounded-xl border border-violet-800 bg-violet-950/30 p-3 text-xs text-violet-100"><span class="en">The challenger is slightly better on point estimates, but both confidence intervals cross zero. It therefore receives zero production weight.</span><span class="es">El retador mejora ligeramente las estimaciones puntuales, pero ambos intervalos cruzan cero. Por eso recibe peso cero en producción.</span></p>
  </div>
