    ...
    <section class="rounded-3xl border border-slate-800 bg-gradient-to-br from-slate-900 to-slate-950 p-6 md:p-8 mb-8">
      <div class="grid lg:grid-cols-[1.25fr_.75fr] gap-8 items-center">
        ...
        <svg id="production-workflow" viewBox="0 0 640 430" role="img" aria-labelledby="flow-title flow-desc" class="w-full">
          ...
          <desc id="flow-desc"><tspan class="en">Sources flow through immutable provenance, chronological model championship, production Poisson scoring, research-gated Dixon-Coles shadow scoring, market shrinkage, five risk lenses, four-role audit, JSON, and a defensive mobile report shell.</tspan><tspan class="es">Las fuentes pasan por procedencia inmutable, campeonato cronológico de modelos, marcador Poisson de producción, Dixon-Coles sombra limitado por investigación, ajuste a mercado, cinco lentes de riesgo, auditoría de cuatro roles, JSON y una página móvil defensiva.</tspan></desc>
          ...
          <g fill="#e2e8f0" font-family="system-ui" font-size="13" text-anchor="middle">
            ...
            <text x="475" y="60"><tspan class="en">Market shrinkage</tspan><tspan class="es">Ajuste a mercado</tspan></text><text x="475" y="80"><tspan class="en">same odds, two model views</tspan><tspan class="es">mismas cuotas, dos vistas</tspan></text>
        ...
        <svg id="research-workflow" viewBox="0 0 640 430" role="img" aria-labelledby="research-flow-title research-flow-desc" class="hidden w-full">
          ...
          <g fill="#e2e8f0" font-family="system-ui" font-size="13" text-anchor="middle">
            <text x="92" y="56"><tspan class="en">Chronological data</tspan><tspan class="es">Datos cronológicos</tspan></text><text x="92" y="76">253 + 40</text>
            ...
            <text x="307" y="246"><tspan class="en">Shadow recommendations</tspan><tspan class="es">Recomendaciones sombra</tspan></text><text x="307" y="266"><tspan class="en">paired candidate review</tspan><tspan class="es">revisión por pares</tspan></text>
    ...
    <section class="mb-8 grid lg:grid-cols-[1fr_1fr] gap-5">
      <div class="rounded-3xl border border-slate-800 bg-slate-900 p-5">
        ...
        <ol class="mt-3 space-y-2 text-sm text-slate-300 list-decimal pl-5">
          ...
          <li><span class="en">Research mode exposes the best gated shadow model for learning and sensitivity analysis; it does not replace production recommendations.</span><span class="es">El modo investigación muestra el mejor modelo sombra limitado por evidencia para aprendizaje y sensibilidad; no reemplaza las recomendaciones de producción.</span></li>
        </ol>
      </div>
      <div class="rounded-3xl border border-slate-800 bg-slate-900 p-5">
...
function renderSummary(rows){
 ...
 <p class="mt-2 text-violet-200"><span class="en">Research-mode toggle: ${escapeHtml(METRICS.research_mode_policy?.selected_candidate||'not available')} is available as a gated shadow view. Production recommendations remain unchanged unless a candidate passes the published promotion gate.</span><span class="es">Toggle de modo investigación: ${escapeHtml(METRICS.research_mode_policy?.selected_candidate||'no disponible')} está disponible como vista sombra limitada. Las recomendaciones de producción no cambian salvo que un candidato supere la puerta de promoción publicada.</span></p>
...
function renderValidationVisuals(){
 ...
 const folds=champ.nested_outer_championship.folds||[];
...
function card(row,index){
 ...
 const researchRecommendations=safeList(research.top_recommendations);
 ...
 return `<article class="card-anchor bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden" data-fixture-id="${escapeHtml(row.fixture_id)}" data-date="${row.kickoff_lima.slice(0,10)}" data-strength="${strength}">
   ...
   <div class="p-5">
    ...
    <section class="mt-4 rounded-2xl border border-slate-800 bg-slate-950/60 p-4">
      ...
      <p class="mt-2 text-xs text-slate-400"><span class="en">Changing the lens changes the review threshold shown on the page; it does not change the saved model probabilities, source odds, or production recommendation.</span><span class="es">Cambiar el lente cambia el umbral de revisión mostrado; no cambia probabilidades guardadas, cuotas fuente ni recomendación de producción.</span></p>
    </section>
    ...
    <section class="research-panel hidden mt-4 rounded-2xl border border-violet-800 bg-violet-950/30 p-4 text-sm" data-research-candidate="${escapeHtml(research.selected_candidate||'')}">
      ...
      <details class="mt-4 rounded-2xl border border-violet-800/80 bg-violet-950/20 p-3" open>
        <summary class="cursor-pointer font-semibold text-violet-100"><span class="en">Research-mode ranked recommendations</span><span class="es">Recomendaciones clasificadas en modo investigación</span> (${researchRecommendations.length}/4)</summary>
        <div class="mt-3 grid gap-3">${researchRankedRecommendations||'<p class="text-sm text-slate-300"><span class="en">No research-mode sourced recommendation could be produced.</span><span class="es">No se pudo producir una recomendación con fuente en modo investigación.</span></p>'}</div>
